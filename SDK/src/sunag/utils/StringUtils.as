...
{	
	...
	public class StringUtils 
	{
		...
		public static function fileSize(length:int):String 
		{
			...
			if (size >= MB)// MB
			{
				str = (size/MB).toString();
				m = "MB";
			}
			else if (size >= kB)
			{
				str = (size/kB).toString();
				m = "kB";
			}
			else
			{
		...
		public static function path(p_string:String):String {
			if (p_string == null) { return ''; }
			return p_string.substr(p_string.search(/\w/));
		}
		
		public static function name(p_string:String):String {
			return beforeLast(p_string, '.');
		}
		
		public static function type(p_string:String):String {
			return afterLast(p_string, '.').toLowerCase();
		}
		...
		public static function count(p_string:String):uint
		{
			var b:ByteArray = new ByteArray();
			b.writeUTFBytes(p_string);
			return b.length;
		}
		...
		public static function listToVectorString(list:*):Vector.<String>
		{
